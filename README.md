...
- Go >= 1.19 — [install](https://go.dev/doc/install).
...
Library](https://github.com/jsightapi/jsight-schema-core) and several other libraries.
...
Please feel free to add a [new issue](https://github.com/jsightapi/jsight-api-core/issues/new)
